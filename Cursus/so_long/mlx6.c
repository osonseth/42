...
/*   Updated: 2024/04/18 01:53:51 by max              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void display_movement_count(t_data *data)
{
    ...
    while (data->str_count_move[i])
    {
        if (data->str_count_move[i] == '0')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_zero, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '1')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_one, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '2')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_two, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '3')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_three, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '4')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_four, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '5')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_five, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '6')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_six, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '7')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_seven, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '8')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_eight, i * 64, data->map_height * 64);
        if (data->str_count_move[i] == '9')
            mlx_put_image_to_window(data->mlx_init, data->mlx_windows, data->mlx_image_font_nine, i * 64, data->map_height * 64);
        i++;
    }
