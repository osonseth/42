...
/*   Updated: 2024/04/17 18:47:28 by max              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (data->map[data->alien_y - 1][data->alien_x] == '0' || data->map[data->alien_y - 1][data->alien_x] == 'P')
    {
...
{
    if (data->map[data->alien_y][data->alien_x - 1] == '0' || data->map[data->alien_y][data->alien_x - 1] == 'P')
    {
